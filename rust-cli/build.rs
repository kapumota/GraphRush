fn main() {
    cxx_build::bridge("src/ffi.rs")
        ...
        .file("../cpp-core/src/Algorithms.cpp")
        .file("../cpp-core/src/ParallelAlgorithms.cpp")
        .file("../cpp-core/src/DeltaStepping.cpp")
    ...
    println!("cargo:rerun-if-changed=../cpp-core/include/graphrush/DeltaStepping.hpp");
    ...
    println!("cargo:rerun-if-changed=../cpp-core/src/Algorithms.cpp");
    println!("cargo:rerun-if-changed=../cpp-core/src/ParallelAlgorithms.cpp");
    println!("cargo:rerun-if-changed=../cpp-core/src/DeltaStepping.cpp");
